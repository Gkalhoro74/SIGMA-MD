...
global.owner = process.env.OWNER_NUMBER  || '923112240173' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "11_05_2024_SIGMA_MD_2xLafSbg_MAHER_ZUBAIR" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "923112240173" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '15_05_2024_SIGMA_MD_Mtd1k3DN_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Mustafa',         // ADD YOUR BOT NAME
